            ...
            <div class="box">
                ...
                <div class="box-footer">
                    <span style="color: #ccc" class="pull-right">
                        创建日期：<fmt:formatDate value="${sale.createTime}" pattern="yyyy-MM-dd HH:mm"/>
                    </span>
                </div>
            </div>
                ...
                <div class="col-md-8">
                    ...
                    <ul class="timeline">
                        ...
                        <c:forEach items="${records}" var="record">
                            <c:choose>
                                <c:when test="${record.text == '将当前进度修改为：[ 成交 ]'}">
                                    <li>
                                        <!-- timeline icon -->
                                        <i class="fa fa-check bg-green"></i>
                                        <div class="timeline-item">
                                            <span class="time"><i class="fa fa-clock-o"></i> <fmt:formatDate value="${record.time}"/></span>
                                            <div class="timeline-body">
                                                    ${record.text}
                                            </div>
                                        </div>
                                ...
                                <c:when test="${record.text == '将当前进度修改为：[ 暂时搁置 ]'}">
                                    <li>
                                        <!-- timeline icon -->
            ...
            <div class="modal fade" id="changeProgressModal">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="/record/my/${sale.id}/progress/update" id="updateProgressForm">
    ...
    $(function () {
        ...
        $("#delBtn").click(function () {
            layer.confirm("确定要删除该机会吗?",function () {
                window.location.href = "/record/my/"+saleId+"/del";
            });
        });
