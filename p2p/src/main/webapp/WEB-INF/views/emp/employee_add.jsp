            ...
            <form class="form-horizontal" id="addForm" >
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">员工姓名：(<span><strong class="text-danger">*</strong></span>)</label>
                 ...
                 <div class="form-group">
                  <label class="col-sm-2 control-label">身份证号：(<span ><strong class="text-danger">*</strong></span>)</label>
